defmodule PetStoreManager.CustomersTest do
  ...
  describe "pets" do
    ...
    @invalid_attrs %{age: nil, breed: nil, name: nil, owners_last_name: nil, species: nil}
    ...
    test "create_pet/1 with valid data creates a pet" do
      valid_attrs = %{age: 120.5, breed: "some breed", name: "some name", owners_last_name: "some owners_last_name", species: "some species"}

      assert {:ok, %Pet{} = pet} = Customers.create_pet(valid_attrs)
      assert pet.age == 120.5
      assert pet.breed == "some breed"
      assert pet.name == "some name"
      assert pet.owners_last_name == "some owners_last_name"
    ...
    test "update_pet/2 with valid data updates the pet" do
      pet = pet_fixture()
      update_attrs = %{age: 456.7, breed: "some updated breed", name: "some updated name", owners_last_name: "some updated owners_last_name", species: "some updated species"}
      ...
      assert pet.owners_last_name == "some updated owners_last_name"
